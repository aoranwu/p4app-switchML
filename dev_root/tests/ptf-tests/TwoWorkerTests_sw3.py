...
class TwoWorkerTest(SwitchMLTest):
    ...
    def setUp(self):
        ...
        self.all_workers = [
        Worker(mac="e6:5d:09:2e:a3:ac", ip="198.19.200.48", udp_port=12345, front_panel_port=1, lane=1, speed=100, fec='none'),
        Worker(mac="9e:3e:ed:c0:b6:5c", ip="198.19.200.47", udp_port=12345, front_panel_port=1, lane=2, speed=100, fec='none')
        ]
...
class BasicReduction(TwoWorkerTest):
    ...
    def runTest(self):
        ...
        self.pktW0S0.show()
        send_packet(self, 1, self.pktW0S0)
